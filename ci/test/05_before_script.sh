...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > "${HOME}/Library/Application Support/Microcurrency"
else
  CI_EXEC echo \> \$HOME/.microcurrency
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/satoshiware/microcurrency/pull/18288#discussion_r433189350 for
  # details.
