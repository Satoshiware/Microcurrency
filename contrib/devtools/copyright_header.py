...
EXCLUDE = [
    # auto generated:
    'src/qt/microcurrencystrings.cpp',
...
Arguments:
    <base_directory> - The base directory of a microcurrency source code repository.
...
Arguments:
    <file> - A source file in the microcurrency repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Microcurrency
