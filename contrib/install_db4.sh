...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the microcurrency repository."
  exit 1
fi
...
# See https://github.com/satoshiware/microcurrency/issues/16064
...
echo 'When compiling microcurrencyd, run `./configure` in the following way:'
echo
