...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef MICROCURRENCY_CHAINPARAMSSEEDS_H\n')
    g.write('#define MICROCURRENCY_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the microcurrency network\n')
    ...
    g.write('#endif // MICROCURRENCY_CHAINPARAMSSEEDS_H\n')
