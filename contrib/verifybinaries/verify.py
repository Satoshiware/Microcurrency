...
"""Script for verifying Microcurrency Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
microcurrencycore.org and microcurrency.org and compares them.
...
WORKINGDIR = "/tmp/microcurrency_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://microcurrencycore.org"
HOST2 = "https://microcurrency.org"
VERSIONPREFIX = "microcurrency-core-"
...
def main(args):
    ...
    if not success:
        print("microcurrency.org failed to provide signature file, "
              "but microcurrencycore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("microcurrency.org and microcurrencycore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Microcurrency Core binary release "
