...
Assumeutxo is a feature that allows fast bootstrapping of a validating microcurrencyd
...
- [Github issue](https://github.com/satoshiware/microcurrency/issues/15605)
- [draft PR](https://github.com/satoshiware/microcurrency/pull/15606)
...
considered active. This is the "traditional" mode of operation for microcurrencyd.
...
**Failure consideration:** if microcurrencyd unexpectedly halts after `m_stop_use` is set on
...
### Microcurrencyd restarts sometime after snapshot validation has completed

When microcurrencyd initializes again, what began as the snapshot chainstate is now
