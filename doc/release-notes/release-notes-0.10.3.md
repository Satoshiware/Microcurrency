Microcurrency Core version 0.10.3 is now available from:

  <https://microcurrency.org/bin/microcurrency-core-0.10.3/>
...
(see https://github.com/satoshiware/microcurrency/pull/6793, as well as the 0.11.0
