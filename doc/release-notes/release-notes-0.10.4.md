Microcurrency Core version 0.10.4 is now available from:

  <https://microcurrency.org/bin/microcurrency-core-0.10.4/>
...
- #6953 `43c2789` Split microcurrency-tx into its own package
- #6953 `dfe0d4d` Include microcurrency-tx binary on Debian/Ubuntu
