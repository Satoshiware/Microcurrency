Microcurrency Core version 0.13.2 is now available from:

  <https://microcurrency.org/bin/microcurrency-core-0.13.2/>
...
- #8908 `4a974b2` Update microcurrency-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow microcurrency-tx to create v2 transactions (mcudrak)
