Microcurrency Core version *0.15.0.1* is now available from:

  <https://microcurrency.org/bin/microcurrency-core-0.15.0.1/>

and

  <https://microcurrencycore.org/bin/microcurrency-core-0.15.0.1/>
