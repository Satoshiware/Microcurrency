Microcurrency Core version *0.15.2* is now available from:

  <https://microcurrencycore.org/bin/microcurrency-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in microcurrency-tx (TheBlueMatt)
