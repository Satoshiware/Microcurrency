Microcurrency Core version 0.16.1 is now available from:

  <https://microcurrencycore.org/bin/microcurrency-core-0.16.1/>
...
- #12843 `df38b13` Test starting microcurrencyd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure microcurrencyd processes are cleaned up when tests end (sdaftuar)
