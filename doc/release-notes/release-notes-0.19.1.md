...
Microcurrency Core version 0.19.1 is now available from:

  <https://microcurrencycore.org/bin/microcurrency-core-0.19.1/>
...
From Microcurrency Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Microcurrency Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Microcurrency Core does not yet change appearance when
...
- #17488 fix "microcurrencyd already running" warnings on macOS (fanquake)
