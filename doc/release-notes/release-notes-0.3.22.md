Download URL: https://sourceforge.net/projects/microcurrency/files/satoshiware/microcurrency-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MCU fee schedule (users still pay 0.01 MCU per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #microcurrency00 - #microcurrency99
