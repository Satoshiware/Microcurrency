Microcurrency version 0.5.4 is now available for download at:
http://sourceforge.net/projects/microcurrency/files/satoshiware/microcurrency-0.5.4/
...
http://gitorious.org/satoshiware/microcurrencyd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Microcurrency-Qt notifications under Growl 1.3.
Increase required age of Microcurrency-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMicrocurrency properly when installing Microcurrency-Qt over it. (Windows)
