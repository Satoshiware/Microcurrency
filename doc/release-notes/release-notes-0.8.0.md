Microcurrency-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/microcurrency/files/satoshiware/microcurrency-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Microcurrency
...
New/changed settings (command-line or microcurrency.conf file)
--------------------------------------------------------
