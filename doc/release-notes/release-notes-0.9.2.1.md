Microcurrency Core version 0.9.2.1 is now available from:

  https://microcurrency.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MCU to 0.01 MCU
...
- Fix "Start microcurrency on system login"
