Microcurrency Core version 0.9.4 is now available from:

  https://microcurrency.org/bin/0.9.4/
...
this update is incompatible with the Microcurrency system and could lead to consensus
forks.

Microcurrency Core released binaries from https://microcurrency.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~microcurrency/+archive/ubuntu/microcurrency
- A third-party or self-compiled Microcurrency Core

upgrade to Microcurrency Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
