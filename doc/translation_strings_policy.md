...
This document provides guidelines for internationalization of the Microcurrency Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `microcurrency_en.ts` remains unchanged.
