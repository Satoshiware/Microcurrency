...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.microcurrency.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me."); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.microcurrency.dashjr.org."); // Luke Dashjr
        vSeeds.emplace_back("seed.microcurrencystats.com."); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.microcurrency.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.mcu.petertodd.org."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.microcurrency.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.microcurrency.wiz.biz."); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.microcurrency.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tmcu.petertodd.org.");
        vSeeds.emplace_back("seed.testnet.microcurrency.sprovoost.nl.");
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("seed.signet.microcurrency.sprovoost.nl.");
