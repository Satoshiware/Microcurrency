...
#ifndef MICROCURRENCY_COMPAT_ASSUMPTIONS_H
#define MICROCURRENCY_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Microcurrency cannot be compiled without assertions."
#endif
...
#endif // MICROCURRENCY_COMPAT_ASSUMPTIONS_H
