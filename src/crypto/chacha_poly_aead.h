...
#ifndef MICROCURRENCY_CRYPTO_CHACHA_POLY_AEAD_H
#define MICROCURRENCY_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@microcurrency.
 *
 ...
 *
 * The chacha20-poly1305@microcurrency combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@microcurrency cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@microcurrency are relatively fast in
...
#endif // MICROCURRENCY_CRYPTO_CHACHA_POLY_AEAD_H
