...
#ifndef MICROCURRENCY_INTERFACES_INIT_H
#define MICROCURRENCY_INTERFACES_INIT_H
...
//! (microcurrency-gui, microcurrency-node, microcurrency-wallet, microcurrencyd, microcurrency-qt) and each
...
#endif // MICROCURRENCY_INTERFACES_INIT_H
