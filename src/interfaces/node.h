...
#ifndef MICROCURRENCY_INTERFACES_NODE_H
#define MICROCURRENCY_INTERFACES_NODE_H
...
//! Top-level interface for a microcurrency node (microcurrencyd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // MICROCURRENCY_INTERFACES_NODE_H
