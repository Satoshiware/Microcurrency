...
#ifndef MICROCURRENCY_IPC_PROCESS_H
#define MICROCURRENCY_IPC_PROCESS_H
...
//! IPC process interface for spawning microcurrency processes and serving requests
...
#endif // MICROCURRENCY_IPC_PROCESS_H
