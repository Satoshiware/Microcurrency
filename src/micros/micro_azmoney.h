...
#ifndef MICROCURRENCY_MICROS_MICRO_AZMONEY_H
#define MICROCURRENCY_MICROS_MICRO_AZMONEY_H

#define MICROCURRENCY       "azmoney"
#define BECH32HRP           "az"

#define BLOCKREWARD         15          // Microcurrency's Block Reward = 50. Note: to run tests, it must be 50!
#define MAXSUPPLY           7637625    	// Microcurrency's Max Supply = 21000000

#define HALVINGINTERVAL		262800      // Microcurrency's Subsidy Halving Interval = 210000

#define TIMESTAMP           "MCU BLK: 0000000000000000000021bb823d8518bfa49c6f16bce1545c4977eb829238a9 TXID: b5f53d64..."
...
#endif // MICROCURRENCY_MICROS_MICRO_AZCOIN_H

/*
python3 genesis.py -t 1676412978 -z "MCU BLK: 0000000000000000000021bb823d8518bfa49c6f16bce1545c4977eb829238a9 TXID: b5f53d64..." -v 1500000000
algorithm: SHA256
merkle hash: b9ed7f5a0f23a5063818064eb28979ca1a22fdbc38fbeb3726f759d83e82a69a
pszTimestamp: MCU BLK: 0000000000000000000021bb823d8518bfa49c6f16bce1545c4977eb829238a9 TXID: b5f53d64...
