...
#ifndef MICROCURRENCY_MICROS_MICRO_DESERETMONEY_H
#define MICROCURRENCY_MICROS_MICRO_DESERETMONEY_H

#define MICROCURRENCY       "deseretmoney"
#define BECH32HRP           "ut"

#define BLOCKREWARD         7          // Microcurrency's Block Reward = 50. Note: to run tests, it must be 50!
#define MAXSUPPLY           3564225    // Microcurrency's Max Supply = 21000000

#define HALVINGINTERVAL     262800      // Microcurrency's Subsidy Halving Interval = 210000

#define TIMESTAMP           "MCU BLK: 000000000000000000050c443844cd8f5418afcf98d6919f8c4a3fa16422219b TXID: 5043ea3b..."
...
#define MAXBLOCKSIZE        100000      // Microcurrency's Max Block Size = 4000000
#define MAXSTANDARDTXWEIGHT 25000

#endif // MICROCURRENCY_MICROS_MICRO_DESERETMONEY_H

/*
python3 genesis.py -t 1690242443 -z "MCU BLK: 000000000000000000050c443844cd8f5418afcf98d6919f8c4a3fa16422219b TXID: 5043ea3b..." -v 700000000 -b 0x1c00ff00 -n 1960094637
algorithm: SHA256
merkle hash: f19430c99d84d77f07c9183c802b147ed9e183840e0df93d3d51c9948b7ed076
pszTimestamp: MCU BLK: 000000000000000000050c443844cd8f5418afcf98d6919f8c4a3fa16422219b TXID: 5043ea3b...
