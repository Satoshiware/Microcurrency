...
#ifndef MICROCURRENCY_POLICY_POLICY_H
#define MICROCURRENCY_POLICY_POLICY_H
...
static const unsigned int MAX_STANDARD_TX_WEIGHT = MAXSTANDARDTXWEIGHT;
...
#endif // MICROCURRENCY_POLICY_POLICY_H
