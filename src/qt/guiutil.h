...
#ifndef MICROCURRENCY_QT_GUIUTIL_H
#define MICROCURRENCY_QT_GUIUTIL_H
...
/** Utility functions used by the Microcurrency Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "microcurrency:" URI into recipient object, return true on successful parsing
...
#endif // MICROCURRENCY_QT_GUIUTIL_H
