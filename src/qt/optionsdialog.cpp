    ...
    mapper(nullptr)
{
    ...
    ui->microcurrencyAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->microcurrencyAtStartup);
    ...
    ui->microcurrencyAtStartup->setToolTip(ui->microcurrencyAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->microcurrencyAtStartup->setText(ui->microcurrencyAtStartup->text().arg(PACKAGE_NAME));

    ui->openMicrocurrencyConfButton->setToolTip(ui->openMicrocurrencyConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MicrocurrencyUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->microcurrencyAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSMCUontrols);
...
void OptionsDialog::on_openMicrocurrencyConfButton_clicked()
{
    ...
    if (!GUIUtil::openMicrocurrencyConf())
