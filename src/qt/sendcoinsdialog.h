...
#ifndef MICROCURRENCY_QT_SENDCOINSDIALOG_H
#define MICROCURRENCY_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending microcurrencys */
...
#endif // MICROCURRENCY_QT_SENDCOINSDIALOG_H
