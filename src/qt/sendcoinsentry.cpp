    ...
    platformStyle(_platformStyle)
{
    ...
    // normal microcurrency address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying microcurrency address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MicrocurrencyAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
