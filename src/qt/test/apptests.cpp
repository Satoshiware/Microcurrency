...
//! Entry point for MicrocurrencyApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MicrocurrencyApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MicrocurrencyGUI tests.
void AppTests::guiTests(MicrocurrencyGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MicrocurrencyGUI::consoleShown, this, &AppTests::consoleTests);
