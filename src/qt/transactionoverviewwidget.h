...
#ifndef MICROCURRENCY_QT_TRANSACTIONOVERVIEWWIDGET_H
#define MICROCURRENCY_QT_TRANSACTIONOVERVIEWWIDGET_H
...
#endif // MICROCURRENCY_QT_TRANSACTIONOVERVIEWWIDGET_H
