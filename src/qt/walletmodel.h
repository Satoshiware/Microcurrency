...
#ifndef MICROCURRENCY_QT_WALLETMODEL_H
#define MICROCURRENCY_QT_WALLETMODEL_H
...
/** Interface to Microcurrency wallet from Qt view code. */
...
#endif // MICROCURRENCY_QT_WALLETMODEL_H
