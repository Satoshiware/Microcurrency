...
#ifndef MICROCURRENCY_QT_WALLETVIEW_H
#define MICROCURRENCY_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a microcurrency wallet, and offers access to
...
#endif // MICROCURRENCY_QT_WALLETVIEW_H
