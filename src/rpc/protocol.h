...
#ifndef MICROCURRENCY_RPC_PROTOCOL_H
#define MICROCURRENCY_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in microcurrencyd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Microcurrency is not connected
...
#endif // MICROCURRENCY_RPC_PROTOCOL_H
