...
#ifndef MICROCURRENCY_SCRIPT_SCRIPT_H
#define MICROCURRENCY_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Microcurrency always counted CHECKMULTISIGs
...
#endif // MICROCURRENCY_SCRIPT_SCRIPT_H
