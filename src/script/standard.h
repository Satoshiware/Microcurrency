...
#ifndef MICROCURRENCY_SCRIPT_STANDARD_H
#define MICROCURRENCY_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a microcurrency address
 */
...
/**
 * Generate a Microcurrency scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MICROCURRENCY_SCRIPT_STANDARD_H
