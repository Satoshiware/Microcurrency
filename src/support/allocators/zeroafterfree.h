...
#ifndef MICROCURRENCY_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define MICROCURRENCY_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // MICROCURRENCY_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
