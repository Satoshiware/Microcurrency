...
{
    BOOST_CHECK(TestSplitHost("www.microcurrencycore.org", "www.microcurrencycore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.microcurrencycore.org]", "www.microcurrencycore.org", 0));
    BOOST_CHECK(TestSplitHost("www.microcurrencycore.org:80", "www.microcurrencycore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.microcurrencycore.org]:80", "www.microcurrencycore.org", 80));
