...
#ifndef MICROCURRENCY_TEST_SCRIPTNUM10_H
#define MICROCURRENCY_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Microcurrency Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MICROCURRENCY_TEST_SCRIPTNUM10_H
