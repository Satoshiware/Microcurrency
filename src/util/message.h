...
#ifndef MICROCURRENCY_UTIL_MESSAGE_H
#define MICROCURRENCY_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's microcurrency address, it must refer to a public key.
...
#endif // MICROCURRENCY_UTIL_MESSAGE_H
