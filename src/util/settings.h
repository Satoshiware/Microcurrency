...
#ifndef MICROCURRENCY_UTIL_SETTINGS_H
#define MICROCURRENCY_UTIL_SETTINGS_H
...
//!       https://github.com/satoshiware/microcurrency/pull/15934/files#r337691812)
...
#endif // MICROCURRENCY_UTIL_SETTINGS_H
