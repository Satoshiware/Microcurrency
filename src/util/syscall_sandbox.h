...
#ifndef MICROCURRENCY_UTIL_SYSCALL_SANDBOX_H
#define MICROCURRENCY_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during microcurrencyd initialization if Microcurrency Core was compiled
...
#endif // MICROCURRENCY_UTIL_SYSCALL_SANDBOX_H
