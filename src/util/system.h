 ...
 */
#ifndef MICROCURRENCY_UTIL_SYSTEM_H
#define MICROCURRENCY_UTIL_SYSTEM_H
...
extern const char * const MICROCURRENCY_CONF_FILENAME;
extern const char * const MICROCURRENCY_SETTINGS_FILENAME;
...
#endif // MICROCURRENCY_UTIL_SYSTEM_H
