...
#ifndef MICROCURRENCY_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define MICROCURRENCY_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // MICROCURRENCY_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
