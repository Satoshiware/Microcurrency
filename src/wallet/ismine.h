...
#ifndef MICROCURRENCY_WALLET_ISMINE_H
#define MICROCURRENCY_WALLET_ISMINE_H
 ...
 * https://github.com/satoshiware/microcurrency/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // MICROCURRENCY_WALLET_ISMINE_H
