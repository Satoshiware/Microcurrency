...
#ifndef MICROCURRENCY_WALLET_SCRIPTPUBKEYMAN_H
#define MICROCURRENCY_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Microcurrency Core wallet was originally a collection of unrelated private
...
#endif // MICROCURRENCY_WALLET_SCRIPTPUBKEYMAN_H
