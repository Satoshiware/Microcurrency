...
#ifndef MICROCURRENCY_WALLET_TRANSACTION_H
#define MICROCURRENCY_WALLET_TRANSACTION_H
...
public:
     ...
     * on this microcurrency node, and set to 0 for transactions that were created
...
#endif // MICROCURRENCY_WALLET_TRANSACTION_H
