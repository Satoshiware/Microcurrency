...
#ifndef MICROCURRENCY_WALLET_WALLETUTIL_H
#define MICROCURRENCY_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! microcurrency from opening the wallet, thinking it was newly created, and
...
#endif // MICROCURRENCY_WALLET_WALLETUTIL_H
