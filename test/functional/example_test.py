...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MicrocurrencyTestFramework
    pass


class ExampleTest(MicrocurrencyTestFramework):
    # Each functional test is a subclass of the MicrocurrencyTestFramework class.
    ...
    def custom_method(self):
        ...
        MicrocurrencyTestFramework class so other tests can use it."""
