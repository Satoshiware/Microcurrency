...
"""
Test starting microcurrencyd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(MicrocurrencyTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that microcurrencyd has bound on "::1" (for RPC) and "::" (for P2P).
