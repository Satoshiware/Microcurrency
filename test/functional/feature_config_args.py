...
class ConfArgsTest(MicrocurrencyTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'microcurrency.conf'), 'a', encoding='utf-8') as conf:
        ...
        main_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'microcurrency_main.conf')
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "microcurrency.conf")
        ...
        none_existent_conf_file = os.path.join(default_data_dir, "none_existent_microcurrency.conf")
