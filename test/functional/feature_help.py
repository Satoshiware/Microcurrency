...
"""Verify that starting microcurrency with -h works as expected."""

from test_framework.test_framework import MicrocurrencyTestFramework
from test_framework.util import assert_equal

class HelpTest(MicrocurrencyTestFramework):
    ...
    def run_test(self):
        self.log.info("Start microcurrency with -h for help text")
        ...
        self.log.info("Start microcurrency with -version for version information")
        ...
        self.log.info("Start microcurrencyd with -fakearg to make sure it does not start")
