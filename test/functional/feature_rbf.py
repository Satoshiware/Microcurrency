...
class ReplaceByFeeTest(MicrocurrencyTestFramework):
    ...
    def run_test(self):
        ...
        # MicrocurrencyTestFramework._initialize_chain())
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 MCU - so this attempt is rejected.
        dbl_tx = CTransaction()
