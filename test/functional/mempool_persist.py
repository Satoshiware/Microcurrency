...
By default, microcurrencyd will dump mempool on shutdown and
...
class MempoolPersistTest(MicrocurrencyTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent microcurrencyd from writing mempool.dat to disk. Verify that `savemempool` fails")
