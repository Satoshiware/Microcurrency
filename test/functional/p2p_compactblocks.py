...
# TestP2PConn: A peer we use to send messages to microcurrencyd, and store responses.
...
class CompactBlocksTest(MicrocurrencyTestFramework):
    ...
    # This test actually causes microcurrencyd to (reasonably!) disconnect us, so do this last.
    ...
    # microcurrencyd's choice of nonce.
    ...
    # Test that microcurrencyd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for microcurrencyd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # microcurrencyd will not send blocktxn responses for blocks whose height is
