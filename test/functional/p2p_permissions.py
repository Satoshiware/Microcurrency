...
class P2PPermissionsTests(MicrocurrencyTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].microcurrencyconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].microcurrencyconf, 'w', encoding="utf8") as f:
            f.write(newText)
