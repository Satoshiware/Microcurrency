...
Verify that a microcurrencyd node can use an external signer command.
...
class RPCSignerTest(MicrocurrencyTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart microcurrencyd with -signer=<cmd>',
