...
class TransactionTimeRescanTest(MicrocurrencyTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine MCU and create transactions
        ...
        # generate some mcu to create transactions and check blockcount
        ...
        # send 10 mcu to user's first watch-only address
        self.log.info('Send 10 mcu to user')
        ...
        # send 5 mcu to our second watch-only address
        self.log.info('Send 5 mcu to user')
        ...
        # send 1 mcu to our third watch-only address
        self.log.info('Send 1 mcu to user')
