...
class TxnMallTest(MicrocurrencyTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 MCU:
        ...
        # First: use raw transaction API to send 1240 MCU to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MCU coin each
        ...
        # Node0's balance should be starting balance, plus 50MCU for another
        ...
        # Node0's total balance should be starting balance, plus 100MCU for
